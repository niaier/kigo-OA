<template>
  <div class="process-panel__container" :style="{ width: `${this.width}px`,height:'560px' }">
    <el-collapse v-model="activeTab">
      ...
      <!-- <el-collapse-item name="form" key="form">
        <div slot="title" class="panel-tab__title"><i class="el-icon-tickets"></i>表单属性</div>
        <element-properties :id="elementId" :type="elementType" />
      </el-collapse-item> -->
