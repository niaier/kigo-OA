...
export default {
  ...
  methods: {
    ...
    handleSetSelectItem(record) {
      ...
      //设置数据表类型
      console.log(this.data.config.table_type)
      store.commit("SET_TABLE_TYPE", this.data.config.table_type);
      store.commit("SET_TABLE_NAME", this.data.config.table_name);
      // this.$refs.selectItem.selectChange(this.selectItem);
    },
    /**
    ...
    dataConfig() {
      ...
      if (this.formData.config != "" && this.formData.config != undefined) {
