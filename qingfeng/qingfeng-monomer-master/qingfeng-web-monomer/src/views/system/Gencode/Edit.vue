<template>
  ...
  >
    ...
    >
      ...
      <a-row class="form-row" :gutter="16">
        <a-col :lg="12" :md="12" :sm="24">
          <a-form-model-item ref="temp_type" label="模板类型" prop="temp_type">
            <a-select v-model="form.temp_type" placeholder="模板类型">
      ...
      <a-row class="form-row" :gutter="16" v-show="form.temp_type=='0'">
        <a-col :lg="12" :md="12" :sm="24">
          <a-form-model-item
            ref="open_process"
            label="开启工作流"
            prop="open_process"
          >
            <a-select v-model="form.open_process" placeholder="请选择">
        ...
        <a-col :lg="12" :md="12" :sm="24">
          <a-form-model-item
            ...
            prop="process_key"
          >
            <a-select v-model="form.process_key" placeholder="请选择">
              <a-select-option
    ...
    >
      <a-table :data-source="form.fieldList" :pagination="false">
        ...
        <a-table-column key="show_type" title="显示类型" data-index="show_type">
          <template slot-scope="text, record, index">
            <a-select v-model="record.show_type" placeholder="请选择显示类型">
      ...
      <a-row class="form-row" :gutter="16">
        <a-col :lg="12" :md="12" :sm="24">
          <a-form-model-item ref="tree_pid" label="父节点字段" prop="tree_pid">
            <a-select v-model="form.tree_pid" placeholder="父节点字段">
              <a-select-option
        ...
        <a-col :lg="12" :md="12" :sm="24">
          <a-form-model-item
            ...
            prop="tree_name"
          >
            <a-select v-model="form.tree_name" placeholder="节点名称字段">
              <a-select-option
                v-for="(item, index) in form.fieldList"
                :key="index"
                :value="item.field_name"
...
import { getDefinitionList } from "@/api/customize/vmenu";
export default {
  // 声明当前子组件接收父组件传递的属性
  props: {
    record: {
