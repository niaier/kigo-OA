      ...
      <div style="margin: 0 0 10px 0">
        <a-space size="small">
          ...
          <a-button v-action:role:del type="danger" @click="dels()"
            >删除</a-button
          >
          <a-button v-action:role:assignAuth type="primary" @click="auths()"
            >分配权限</a-button
          >
          <a-button v-action:role:download @click="download()">下载</a-button>
        </a-space>
      </div>
...
import { getListPage, del, updateStatus } from "@/api/system/role";
