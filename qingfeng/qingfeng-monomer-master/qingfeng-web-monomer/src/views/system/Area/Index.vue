    ...
    <a-row :gutter="24">
      <a-col :md="24" :lg="6">
        <a-card :bordered="false">
          <area-tree ref="child" @selectTree="selectTree"></area-tree>
        </a-card>
      </a-col>
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button v-action:area:add @click="add()"
                >添加</a-button
              >
              <a-button
                v-action:area:edit
              ...
              <div class="editable-row-operations">
                <a-space size="small">
                  ...
                  <a-button
                    size="small"
                    type="primary"
                    v-action-dauth:[{...record,auth:`area:edit`}]
                    @click="() => edit(record)"
                    >编辑</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-action-dauth:[{...record,auth:`area:del`}]
                    @click="() => del(record)"
                    >删除</a-button
                  >
                  <a-button
...
import { getListPage, delData, updateStatus } from "@/api/system/area";
...
export default {
  ...
  methods: {
    ...
    selectTree(id, name, value) {
      ...
      this.area_cascade = value.split(":")[0];
    ...
    dialogData(record) {
      ...
      record = {
        ...
        area_cascade: this.area_cascade,
