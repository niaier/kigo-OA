  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div style="margin: 0 0 10px 0">
        <a-space size="small">
          <a-button v-action:group:add @click="add()">添加</a-button>
          <a-button v-action:group:edit type="primary" @click="edits()"
            >编辑</a-button
          >
          <a-button v-action:group:del type="danger" @click="dels()"
            >删除</a-button
          >
          <a-button v-action:group:download @click="download()">下载</a-button>
        </a-space>
      </div>
          ...
          <div class="editable-row-operations">
            <a-space size="small">
              ...
              <a-button
                size="small"
                type="primary"
                v-action-dauth:[{...record,auth:`group:edit`}]
                @click="() => edit(record)"
                >编辑</a-button
              >
              <a-button
                size="small"
                type="danger"
                v-action-dauth:[{...record,auth:`group:del`}]
                @click="() => del(record.id)"
                >删除</a-button
              >
              <a-button
