      ...
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button v-action:organize:add @click="add()">添加</a-button>
              <a-button v-action:organize:edit type="primary" @click="edits()"
                >编辑</a-button
              >
              <a-button v-action:organize:del type="danger" @click="dels()"
                >删除</a-button
              >
              <a-button
                ...
                >权限分配</a-button
              >
              <a-button v-action:organize:download @click="download()"
                >下载</a-button
              >
            </a-space>
          </div>
...
import { getListPage, delData, updateStatus } from "@/api/system/organize";
  ...
  methods: {
    ...
    download() {
      window.location.href =
        ...
        "/system/organize/exportData?name=" +
