      ...
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button
                v-action:dictionary:add
                @click="add()"
                >添加</a-button
              >
              <a-button
                v-action:dictionary:edit
                type="primary"
                @click="edits()"
                >编辑</a-button
              >
              <a-button
                v-action:dictionary:del
                type="danger"
                @click="dels()"
                >删除</a-button
              >
              <a-button
                v-action:dictionary:download
                @click="download()"
                >下载</a-button
              >
            </a-space>
              ...
              <div class="editable-row-operations">
                <a-space size="small">
                  ...
                  <a-button
                    size="small"
                    type="primary"
                    v-action-dauth:[{...record,auth:`dictionary:edit`}]
                    @click="() => edit(record)"
                    >编辑</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-action-dauth:[{...record,auth:`dictionary:del`}]
                    @click="() => del(record)"
                    >删除</a-button
                  >
                  <a-button
...
import { getListPage, delData, updateStatus } from "@/api/system/dictionary";
...
export default {
  ...
  methods: {
    ...
    selectTree(id, name, value) {
      ...
      this.dic_cascade = value.split(":")[0];
    ...
    download() {
      window.location.href =
        ...
        "/system/dictionary/exportData?name=" +
