  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div style="margin: 0 0 10px 0">
        <a-space size="small">
          <a-button v-action:mycontent:add @click="add()"
            >添加</a-button
          >
          <a-button
            v-action:mycontent:edit
            type="primary"
            @click="edits()"
            >编辑</a-button
          >
          <a-button
            v-action:mycontent:del
            type="danger"
            @click="dels()"
            >删除</a-button
          >
          ...
          <div class="editable-row-operations">
            <a-space size="small">
              ...
              <a-button
                size="small"
                type="primary"
                v-action-dauth:[{...record,auth:`mycontent:edit`}]
                @click="() => edit(record)"
                >编辑</a-button
              >
              <a-button
                size="small"
                type="danger"
                v-action-dauth:[{...record,auth:`mycontent:del`}]
                @click="() => del(record)"
                >删除</a-button
              >
              <a-button
