      ...
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button v-action:mytree:add @click="add()">添加</a-button>
              <a-button v-action:mytree:edit type="primary" @click="edits()"
                >编辑</a-button
              >
              <a-button v-action:mytree:del type="danger" @click="dels()"
                >删除</a-button
              >
            </a-space>
          </div>
              ...
              <div class="editable-row-operations">
                <a-space size="small">
                  ...
                  <a-button
                    size="small"
                    type="primary"
                    v-action-dauth:[{...record,auth:`mytree:edit`}]
                    @click="() => edit(record)"
                    >编辑</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-action-dauth:[{...record,auth:`mytree:del`}]
                    @click="() => del(record)"
                    >删除</a-button
                  >
                  <a-button
