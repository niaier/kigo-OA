              ...
              <div class="editable-row-operations">
                <a-space size="small">
                  ...
                  <a-button
                    size="small"
                    type="primary"
                    v-action-dauth:[{...record,auth:`chuchai:edit`}]
                  ...
                  <a-button
                    size="small"
                    type="danger"
                    v-action-dauth:[{...record,auth:`chuchai:del`}]
                    v-if="record.processStatus == '0'"
                    @click="() => del(record)"
                    >删除</a-button
                  >
...
import { getListPage, delData, updateStatus } from "@/api/gencode/chuchai";
