...
//    @Bean(name="SchedulerFactory")
//    public SchedulerFactoryBean schedulerFactoryBean() throws IOException {
//        Map job = properties.getDatasource();
//        DataSourceProperty dataSourceProperty = (DataSourceProperty)job.get("base");
//        System.out.println("---------------000-----------------------");
//        System.out.println(dataSource);
//        System.out.println(job);
//        System.out.println(((DataSourceProperty)job.get("base")).getUrl());
//        System.out.println(properties.getPrimary());
//        System.out.println(properties.getP6spy());
//        System.out.println(properties.getOrder());
//        System.out.println(properties.getDruid());
//        System.out.println(properties.getHikari());
//
//        SchedulerFactoryBean factory = new SchedulerFactoryBean();
//        factory.setAutoStartup(true);
