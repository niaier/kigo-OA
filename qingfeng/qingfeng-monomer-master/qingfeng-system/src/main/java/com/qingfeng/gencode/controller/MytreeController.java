...
public class MytreeController extends BaseController {
    ...
    public void save(@Valid @RequestBody Mytree mytree, HttpServletResponse response) throws Exception {
        Json json = new Json();
        try {
    ...
    public void update(@Valid @RequestBody Mytree mytree, HttpServletResponse response) throws Exception {
        Json json = new Json();
        try {
    ...
    public void updateStatus(@Valid @RequestBody Mytree mytree, HttpServletResponse response) throws Exception {
        Json json = new Json();
        try {
