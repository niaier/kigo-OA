package com.qingfeng.activiti.modeler;
...
public class ModelEditorJsonRestResource implements ModelDataJsonConstants {
    ...
    @RequestMapping(value = {"/modeler/model/{modelId}/json"}, method = {org.springframework.web.bind.annotation.RequestMethod.GET}, produces = {"application/json"})
