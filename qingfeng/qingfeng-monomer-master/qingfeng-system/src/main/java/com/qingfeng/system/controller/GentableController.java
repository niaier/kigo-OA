...
//        String userParams = SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    public void gencode(@RequestParam String id, HttpServletResponse response) throws Exception  {
        ...
        //=====================================react端代码生成============================================
        //生成Data
        fprint("gencode/react/TemplateData.d.ts.ftl", root, gen_path+gentable.getBus_name()+File.separator+gentable.getMod_name()+File.separator+FreemarkerParaUtil.react+gentable.getBus_name()+"/data.d.ts");
        //生成Index
        fprint("gencode/react/TemplateIndex.tsx.ftl", root, gen_path+gentable.getBus_name()+File.separator+gentable.getMod_name()+File.separator+FreemarkerParaUtil.react+gentable.getBus_name()+"/index.tsx");
        //生成service
        fprint("gencode/react/TemplateService.ts.ftl", root, gen_path+gentable.getBus_name()+File.separator+gentable.getMod_name()+File.separator+FreemarkerParaUtil.react+gentable.getBus_name()+"/service.ts");
        if(gentable.getTemp_type().equals("1")) {//树表
            //生成TREE
            fprint("gencode/react/TemplateTree.tsx.ftl", root, gen_path + gentable.getBus_name() + File.separator + gentable.getMod_name() + File.separator + FreemarkerParaUtil.react + gentable.getBus_name() + "/components/Tree.tsx");
        }
        //生成更新
        fprint("gencode/react/TemplateUpdateForm.tsx.ftl", root, gen_path+gentable.getBus_name()+File.separator+gentable.getMod_name()+File.separator+FreemarkerParaUtil.react+gentable.getBus_name()+"/components/UpdateForm.tsx");
