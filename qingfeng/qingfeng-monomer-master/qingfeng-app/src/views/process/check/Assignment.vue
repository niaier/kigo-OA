...
<script>
import { findNextAssignment } from "@/api/activiti/index";
import { findGroupUser } from "@/api/system/group";
import SelectOneUser from "../../system/User/SOneUser";
import SelectMoreUser from "../../system/User/SMoreUser";
import SelectUser from "../selectUser/SelectUser";
import SelectMUser from "../selectUser/SelectMUser";
  ...
  methods: {
    initData() {
      findNextAssignment(this.record).then((response) => {
        ...
        console.log('-------------findNextAssignment---------------')
